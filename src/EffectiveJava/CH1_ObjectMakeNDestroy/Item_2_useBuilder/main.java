...
public class main {
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException {
        ...
        // 4. JavaBeans Pattern에 Freeze 기능을 추가하는 방법
        // 객체가 완성되기 전에는 얼리는 방법으로(freezing) 멀티쓰레드 환경에서의 일관성(Consistancy)을 보장할 수 있다.

        NutritionFacts_Freezing facts_Freezing = new NutritionFacts_Freezing();
        ...
        //NutritionFacts_Builder useBuilderObject = new NutritionFacts_Builder.Builder(100, 10, 10, 10, 10, 10).calories(100).build();
